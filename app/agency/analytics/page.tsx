...
interface Analytics {
  ...
  monthlyTrend: { month: string; requests: number; offers: number }[]
}
        ...
        <div className="container">
          ...
          {loading ? (
            <div className="card" style={{ textAlign: 'center', padding: '60px 20px' }}>
              <p style={{ color: '#718096', fontFamily: 'Inter, sans-serif' }}>Yükleniyor...</p>
            </div>
          ) : !analytics ? (
            <div className="card" style={{ textAlign: 'center', padding: '60px 20px' }}>
              <p style={{ color: '#718096', fontFamily: 'Inter, sans-serif' }}>Analytics verisi yüklenemedi.</p>
            </div>
          ) : (
            <>
              {/* Key Metrics */}
                  ...
                  {analytics.monthlyTrend.map((month, i) => (
                    <div key={i} style={{ padding: '16px', background: '#f8f9fa', borderRadius: '6px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '24px', fontSize: '14px', color: '#718096', fontFamily: 'Inter, sans-serif' }}>
                        ...
                        <span>Oran: {month.requests > 0 ? Math.round((month.offers / month.requests) * 100) : 0}%</span>
                      </div>
                    </div>
                  ))}
                </div>
