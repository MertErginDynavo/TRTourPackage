          ...
          <form onSubmit={handleSubmit} style={{ background: 'white', padding: '32px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
            ...
            <div style={{ marginTop: '16px', padding: '12px', background: '#f7fafc', borderRadius: '6px', border: '1px solid #e2e8f0' }}>
              <p style={{ fontSize: '13px', color: '#718096', margin: 0, lineHeight: '1.6', fontFamily: 'Inter, sans-serif' }}>
                Giriş yaparak <Link href="/agency/dashboard" style={{ color: '#4299e1', textDecoration: 'underline' }}>KVKK Aydınlatma Metni</Link>, <Link href="/agency/dashboard" style={{ color: '#4299e1', textDecoration: 'underline' }}>Gizlilik Politikası</Link> ve <Link href="/terms" style={{ color: '#4299e1', textDecoration: 'underline' }}>Kullanım Koşulları</Link>'nı kabul etmiş olursunuz.
              </p>
            </div>
